...
- **Eigen visuele identiteit voorbij de hero**: een gekleurde missiestrook bovenaan elke kaart, asymmetrische paneelhoeken in plaats van de volledig ronde kaarten van 3D/A, en een gestippelde onderlijn bij elke sectietitel. Het eerdere sterrenveld op de achtergrond bleek te druk (onrustig om naar te kijken) en is vervangen door een rustiger kronkelend missiepad: een gestippelde lijn die van boven naar onder door de pagina loopt, met een klein gevuld raketje dat mee naar beneden schuift terwijl je scrolt (`assets/js/mission-trail.js`). Het pad zelf zit net achter de kaarten (zichtbaar in de kieren), het raketje zelf zit er zichtbaar bovenop en kruist gewoon over de kaarten heen.
