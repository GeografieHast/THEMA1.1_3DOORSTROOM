...
- **Eigen visuele identiteit voorbij de hero**: een gekleurde missiestrook bovenaan elke kaart, asymmetrische paneelhoeken in plaats van de volledig ronde kaarten van 3D/A, en een gestippelde onderlijn bij elke sectititel. Het eerdere sterrenveld op de achtergrond bleek te druk (onrustig om naar te kijken) en is vervangen door een missiepad (`assets/js/mission-trail.js`): een gestippelde lijn die gewoon normaal met de pagina meescrolt, met een raketje dat op een vaste plek in het scherm blijft en links-rechts wiebelt volgens je scrollvoortgang. Zo is het altijd zichtbaar, ook nooit ergens boven het scherm verstopt. Een eerdere versie liet het raketje zelf ook in de paginatekst meebewegen; dat bleek bijna altijd exact bovenaan het scherm te blijven hangen (soms zelfs er net buiten), dus vandaar de omschakeling naar een vaste schermpositie.
